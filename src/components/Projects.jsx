...
const Projects = () => {
  ...
  return (    
    <div className='border-b border-neutral-900 pb-4'>
        <motion.h2 whileInView={{opacity:1, y:0}} initial={{opacity:0, y:-100}} transition={{duration:1.5}} className='my-20 text-center text-4xl'>Machine Learning Across Sectors 🧠🔗</motion.h2>
