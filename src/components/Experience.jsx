...
const Experience = () => {
  return (
        <div className='border-b border-neutral-900 pb-4'>
            <motion.h2 whileInView={{opacity:1, y:0}} initial={{opacity:0, y:-100}} transition={{duration:1.5}} className='my-20 text-center text-2xl'>Professional Journey</motion.h2>
            <div className='flex justify-center'>
                <div className='mb-8 flex lg:justify-center'>
                    <motion.div whileInView={{opacity:1, x:0}} initial={{opacity:0, x:-100}} transition={{duration:1}} className='w-full lg:w-1/4 justify-center items-center '>
                        <p className='mb-2 text-violet-200 text-xl'>July 2024</p>
                    </motion.div>
                    <motion.div whileInView={{opacity:1, x:0}} initial={{opacity:0, x:100}} transition={{duration:1}} className='w-full lg:pl-1/2 lg:w-3/4'>
                        <motion.button 
                            ...
                            className=" border-pink-500 bg-gradient-to-r from-pink-400 via-slate-200 to-purple-500 bg-clip-text text-2xl tracking-tight text-transparent">
                            <a href="https://github.com/JaySinghvi/Quantitative-Research"><h2 className='mb-2 fon-semibold text-2xl pb-3'>Quantitative Research Intern - <span className='text-xl text-white'>JP Morgan Chase & Co.</span></h2></a>
                        </motion.button>
                        <ul className='mb-3 text-xl list-disc pl-5 lg:justify-center '>
                        ...
                        <div className='flex flex-wrap'>
                            <span className='mr-2 mt-2 rounded bg-neutral-900 px-2 py-1 text-xl font-medium text-purple-500'>Dynamic Programming</span>
                            <span className='mr-2 mt-2 rounded bg-neutral-900 px-2 py-1 text-xl font-medium text-purple-500'>Financial Modeling</span>
                            <span className='mr-2 mt-2 rounded bg-neutral-900 px-2 py-1 text-xl font-medium text-purple-500'>Risk Management</span>
                            <span className='mr-2 mt-2 rounded bg-neutral-900 px-2 py-1 text-xl font-medium text-purple-500'>Quantitative Analysis</span>
                        </div>            
            ...
            <div className='flex justify-center'>
                <div className='mb-8 flex lg:justify-center'>
                    <motion.div whileInView={{opacity:1, x:0}} initial={{opacity:0, x:-100}} transition={{duration:1}} className='w-full lg:w-1/4 justify-center items-center '>
                        <p className='mb-2 text-violet-200 text-xl'>May 2024 - June 2024</p>
                    </motion.div>
                    <motion.div whileInView={{opacity:1, x:0}} initial={{opacity:0, x:100}} transition={{duration:1}} className='w-full lg:pl-1/2 lg:w-3/4'>
                        <motion.button 
                            whileHover={{ scale: 1.2 }}
                            ...
                            transition={{ type: "spring", stiffness: 400, damping: 17, duration: 1.5 }} 
                            className=" border-pink-500 bg-gradient-to-r from-pink-400 via-slate-200 to-purple-500 bg-clip-text text-2xl tracking-tight text-transparent">
                            <a href="https://app.moonshotpirates.com/voting/climate-24?team=1715422576809x820019839363973100"><h2 className='mb-2 fon-semibold text-2xl pb-3'>Future Shaper - <span className='text-xl text-white'>Moonshot Pirates</span></h2></a>
                        </motion.button>
                        <ul className='mb-3 text-xl list-disc pl-5 lg:justify-center '>
                        ...
                        <div className='flex flex-wrap'>
                            <span className='mr-2 mt-2 rounded bg-neutral-900 px-2 py-1 text-xl font-medium text-purple-500'>Django</span>
                            <span className='mr-2 mt-2 rounded bg-neutral-900 px-2 py-1 text-xl font-medium text-purple-500'>Data Collection</span>
                            <span className='mr-2 mt-2 rounded bg-neutral-900 px-2 py-1 text-xl font-medium text-purple-500'>Video Presentation</span>
                            <span className='mr-2 mt-2 rounded bg-neutral-900 px-2 py-1 text-xl font-medium text-purple-500'>Global Collaboration</span>
                            <span className='mr-2 mt-2 rounded bg-neutral-900 px-2 py-1 text-xl font-medium text-purple-500'>Problem Solving</span>
                        </div>            
            ...
            <div className='flex justify-center'>
                <div className='mb-8 flex lg:justify-center'>
                    <motion.div whileInView={{opacity:1, x:0}} initial={{opacity:0, x:-100}} transition={{duration:1}} className='w-full lg:w-1/4 justify-center items-center '>
                        <p className='mb-2 text-violet-200 text-xl'>July 2023 - August 2023</p>
                    </motion.div>
                    <motion.div whileInView={{opacity:1, x:0}} initial={{opacity:0, x:100}} transition={{duration:1}} className='w-full lg:pl-1/2 lg:w-3/4'>
                        <motion.button 
                            whileHover={{ scale: 1.2 }}
                            ...
                            transition={{ type: "spring", stiffness: 400, damping: 17, duration: 1.5 }} 
                            className=" border-pink-500 bg-gradient-to-r from-pink-400 via-slate-200 to-purple-500 bg-clip-text text-2xl tracking-tight text-transparent">
                            <a href="https://github.com/JaySinghvi/Data-Analyst-Internship-Excelerate"><h2 className='mb-2 fon-semibold text-2xl pb-3'>Data Analyst - <span className='text-xl text-white'>Excelerate</span></h2></a>
                        </motion.button>
                        <ul className='mb-3 text-xl list-disc pl-5 lg:justify-center '>
                        ...
                        <div className='flex flex-wrap'>
                            <span className='mr-2 mt-2 rounded bg-neutral-900 px-2 py-1 text-xl font-medium text-purple-500'>Ad-Optimization</span>
                            <span className='mr-2 mt-2 rounded bg-neutral-900 px-2 py-1 text-xl font-medium text-purple-500'>Data Visualization</span>
                            <span className='mr-2 mt-2 rounded bg-neutral-900 px-2 py-1 text-xl font-medium text-purple-500'>Global Collaboration</span>
                            <span className='mr-2 mt-2 rounded bg-neutral-900 px-2 py-1 text-xl font-medium text-purple-500'>Award Recognition</span>
                        </div>            
