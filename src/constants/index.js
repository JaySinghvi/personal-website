...
export const HERO_CONTENT = `Hi, I’m Jay 👋                                        🔭 I build intelligent systems that merge data, design, and business — from disaster response platforms to emotion-aware music recommenders
